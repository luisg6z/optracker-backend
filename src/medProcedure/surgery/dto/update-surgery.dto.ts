...
export class UpdateSurgeryDto extends PartialType(CreateSurgeryDto) {
  ...
  @ApiProperty({
    enum: Status,
    enumName: 'Status-enum',
    description: 'Progreso de la cirugía',
  })
  @IsOptional()
  @IsEnum(Status)
  status: Status;
  ...
  @ApiProperty({
    type: Number,
    description: 'Ids de las enfermeras',
    isArray: true,
  })
  @IsOptional()
  @IsNumber({}, { each: true })
  ...
  @ApiProperty({
    type: Number,
    description: 'Ids de los doctores',
    isArray: true,
  })
  @IsOptional()
  @IsNumber({}, { each: true })
  ...
  @ApiProperty({
    type: Number,
    description: 'Ids de los procedimientos',
    isArray: true,
  })
  @IsOptional()
  @IsNumber({}, { each: true })
...
export class UpdateStatusProcedureDTO {
  ...
  @ApiProperty({
    type: Boolean,
    description: 'Es verdadero cuando el procedimiento ha sido completado',
  })
  @IsOptional()
  @IsBoolean()
  done: boolean;
