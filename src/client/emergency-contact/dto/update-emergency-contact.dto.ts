...
export class UpdateEmergencyContactDto extends PartialType(
  ...
  @ApiProperty({
    type: String,
    description: 'Correo electrónico del contacto de emergencia',
  })
  @IsOptional()
  @IsString()
  @IsEmail()
  ...
  @ApiProperty({
    type: String,
    description: 'Documento de identidad del contacto de emergencia',
  })
  @IsOptional()
  @IsString()
  dni: string;
  ...
  @ApiProperty({
    type: Number,
    description:
      'Clave foránea del paciente que se esté registrando para esta cirugía',
  })
  @IsOptional()
  @IsNumber()
  patientId: number;
